...
% add this to prevent bug, LBY 20200414
if centerindex == length(x)
    width = nan;
    disp('Warning: There might be sth. wrong, the centerindex is the last one!');
    return;
end
