...
par.sr = 22000;                      % sampling rate (in Hz). This parameter will be only used if the data file don't have a sr. 
...
par.w_pre = 30;                      % number of pre-event data points stored (default 20) 
par.w_post = 34;                     % number of post-event data points stored (default 44)) 
