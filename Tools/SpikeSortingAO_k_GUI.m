...
function h1 = SpikeSortingAO_k_GUI()
...
ori_data = [];
monkeys = {'Qiaoqiao';'Polo';'baiya'}; % Add or change Monkeys here
...
h_pathName = uicontrol(...
    ...
    'String','Z:\Data\MOOG\baiya\raw\LA\',...
    'Style','edit',...
    'Tag','Pathname');
...
hLoadData = uicontrol(...
    ...
    'Position',[23 8.846153846153852 15 3.23076923076923],...
    'String','Load',...
    'Tag','LoadData');
...
hInfo = uicontrol(...
    ...
    'Position',[38 8.846153846153852 12 3.23076923076923],...
    'String','Info',...
    'Tag','info');
...
hMergeAO = uicontrol(...
    ...
    'Position',[50 8.846153846153852 12 3.23076923076923],...
    'String','GO!',...
    'Tag','pushbutton6');
...
'FontWeight','bold',...
'ForegroundColor',[0.247058823529412 0.247058823529412 0.247058823529412],...
'Position',[37 1.15384615384615 18 3.23076923076923],...
'String','ChOrder',...
'Tag','SpikeSorting');
...
'Parent',h1,...
'Units','characters',...
'Callback','mergeAO_kilosort(''combine tasks'')',...
'FontSize',12,...
'FontWeight','bold',...
'ForegroundColor',[1 0.6 0],...
'Position',[63 8.846153846153852 17 3.23076923076923],...
'String','Combine',...
'Tag','SpikeSorting');
...
'FontWeight','bold',...
'HorizontalAlignment','left',...
'Position',[63 5 53.4 2.38461538461538],...
'String','Split cluster files : ',...
'Style','text');

hSplit = uicontrol(...
'Parent',h1,...
'Units','characters',...
'Callback','mergeAO_kilosort(''splitting'')',...
'FontSize',12,...
'FontWeight','bold',...
'ForegroundColor',[0.247058823529412 0.247058823529412 0.247058823529412],...
'Position',[63.5 1.15384615384615 15 3.23076923076923],...
'String','Split',...
'Tag','SpikeSorting');
