...
%               2   0.13  6    'Gu 2006 2010 tuning (combined)'
    ...
    %           1   0.2   2    'HeTao heading (visual only) HH'
    %           2 0.18 6 'Polo training HH'
    %           1.5   0.2  3.5   'Polo heading (original) HH'
    %           1.5   0.1  4  'Polo heading (combined) HH'
    %           2.0   0.2  4.0  'Polo heading (combined) HH'
    %           1.5   0.14  3.8  'Minimoog'
%     1.5   0.1  4.9  'Change sigma 1 HH'
%     1.5   0.25  2.3  'Change sigma 2 HH'
%               1.5   0.11  3  'Change sigma pre 3 LBY'
%               1.5   0.11  4.5  'Change sigma pre 4.5 LBY'
%               1.5   0.11  6  'Change sigma pre 6 LBY'
%     1.5   0.11  4.5  '3D Tuning, LBY'
    1.5   0.1  6  'Change sigma, narrow LBY'
    1.5   0.24  2.7  'Change sigma, wide LBY' % 突然升起，没有前面的平台期
%     1.5   0.25  3  'Change sigma, wide LBY'
    % 虽然duration变大可以有效拉开peak time，但是此时的acceleration可能达不到引发反应的阈值
% 2   0.1  8  'Change sigma, narrow LBY'
%     2   0.25  4  'Change sigma, wide LBY' % 突然升起，没有前面的平台期
    };
...
for i=1:size(paras,1)
    ...
    %     ylim([-0.12 0.12]);
    ylim([min(accel) max(accel)]); % changed by LBY, 20200408
