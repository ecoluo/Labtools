...
%         text(0.85,sqrt(3)/4+0.05,label3,'horizontalalignment','center','rotation',-60);
    ...
    % changed by LBY 20171222
    text(0.93,0.04,label2,'horizontalalignment','right');
    text(0.18,0.04,label1,'horizontalalignment','right');
    text(0.57,sqrt(0.75)-0.15,label3,'horizontalalignment','right');
end