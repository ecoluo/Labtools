function [sum_image ,network_color, handle_1, handle_2] = plot_network_fus(anatomical,network_mask,threshold,neg_threshold,mask_scaling,invert_anatomical_colors,anatomical_scaling)
...
if (nargout == 0) || (nargout >= 3)
    % Show the scale
    handle_1 = figure;imagesc(network_mask_orig);colorbar;colormap('jet');axis equal;axis off;    
