function [ReHoBrain] = reho_cwj(AllVolume, NVoxel, Mask,  CUTNUMBER)
...
%     [AllVolume,theImgFileList] =rest_to4d(AllVolume);%消去Header，vsize
% end

[nDim1 nDim2 nDim3 nDimTimePoints]=size(AllVolume);
M=nDim1;N=nDim2;O=nDim3;
isize = [nDim1 nDim2 nDim3]; 
%删掉vsize = sqrt(sum(Header.mat(1:3,1:3).^2));
%mask= spm_vol(AMaskFilename);
