...
% --- Executes on button press in PSTH(3DTuning).
function PSTH_3DTuning_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton16 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if ismember('control',get(gcf,'currentModifier'))
    edit Group_PSTH_3DTuning;
    return;
end
...
function_handles = Group_PSTH_3DTuning(data,get(handles.tolerance,'value'));
