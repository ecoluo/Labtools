% This is for catenating *.mat files converted from alpha-omega *.mpx files (limited by 1G) together
...
h1 = figure(...
    ...
    'MenuBar','none',...
    'Name','---- Merge AO files GUI ----',...
    'NumberTitle','off',...
    'PaperPosition',get(0,'defaultfigurePaperPosition'),...
    'Position',[-150 50 100 23],...
    'Resize','off',...
...
h2 = uicontrol(...
    ...
    'Position',[6.5 18.0000000000001 17.8 2.38461538461538],...
    'String','Monkey: ',...
    'Style','text',...
    'Tag','text1');
...
h3 = uicontrol(...
    ...
    'FontSize',12,...
    'HorizontalAlignment','left',...
    'Position',[6.5 14.923076923077 17.8 2.38461538461538],...
    'String','File name:',...
    'Style','text',...
    'Tag','text2');
...
h22 = uicontrol(...
    ...
    'FontSize',12,...
    'HorizontalAlignment','left',...
    'Position',[6.5 12.0769230769231 9.2 2.38461538461538],...
    'String','#Ch:',...
    'Style','text',...
    'Tag','text1');
...
hRefreshDataPath = uicontrol(...
    ...
    'HorizontalAlignment','left',...
    'Position',[6.5 9.5 15 2.38461538461538],...
    'String','Data path:',...
    'Style','pushbutton');
...
hRefreshSavePath = uicontrol(...
    ...
    'HorizontalAlignment','left',...
    'Position',[6.5 6.5 15 2.38461538461538],...
    'String','Save path:',...
    'Style','pushbutton');
...
hLoadData = uicontrol(...
    ...
    'Position',[23 1.84615384615385 20 3.23076923076923],...
    'String','Load data',...
    'Tag','LoadData');
...
hInfo = uicontrol(...
    ...
    'Position',[45 1.84615384615385 12 3.23076923076923],...
    'String','Info',...
    'Tag','info');
...
hInfoShowPanel = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'ForegroundColor',[0 0.6902 0.3137],...
    'Position',[57 13 35 5.30769230769231],...
...
hMergeAO = uicontrol(...
    ...
    'Position',[59 1.84615384615385 12 3.23076923076923],...
    'String','GO!',...
    'Tag','pushbutton6');
...
'Position',[6 1.84615384615385 15 3.23076923076923],...
'String','To .mat');
...
hSaveFiles = uicontrol(...
    ...
    'Position',[73 1.84615384615385 20 3.23076923076923],...
    'String','Save files',...
    'Tag','save files');
...
'FontSize',6,...
'Position',[46.4 15.3846153846154 8 2.23076923076923],...
'String','Refresh',...
'Tag','pushbutton1');
