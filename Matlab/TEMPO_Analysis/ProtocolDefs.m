...
% %{
% LBY added for not display warning 20180612
moog_keywords{num_keys}='OC_MODE';		        OC_MODE=num_keys; 		        num_keys=num_keys+1;
moog_keywords{num_keys}='CURVE_FLAG';		        CURVE_FLAG=num_keys; 		        num_keys=num_keys+1;
% moog_keywords{num_keys}='PURSUIT_FLAG';		       PURSUIT_FLAG=num_keys; 		        num_keys=num_keys+1;
% moog_keywords{num_keys}='PURSUIT_CNST_SPD';		        PURSUIT_CNST_SPD=num_keys; 		        num_keys=num_keys+1;
% moog_keywords{num_keys}='SACCADE_TIME';		        SACCADE_TIME=num_keys; 		        num_keys=num_keys+1;
% moog_keywords{num_keys}='TRAPEZOID_TIME1';		        TRAPEZOID_TIME1=num_keys; 		        num_keys=num_keys+1;
