...
set(h0, 'Color',[0.8 0.8 0.8], ...
	'Colormap',mat0, ...
	'FileName','E:\Matlab\TEMPO_GUI_LA.m', ...
	'Name','=== TEMPO GUI (LA) ===', ...
    'NumberTitle','off',...
...
h_pathName = uicontrol('Parent',h0, ...
	...
	'String','Z:\Data\MOOG\Qiaoqiao\raw\LA\', ...
	'Style','edit', ...
	'Tag','Pathname');
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'Callback','TEMPO_GUI_Switchyard_LA(''file info'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'Callback','TEMPO_GUI_Switchyard_LA(''load data'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','pix', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','global JustEditIt; JustEditIt = 2; TEMPO_GUI_Switchyard_LA(''analyze'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	...
	'Callback','global JustEditIt; JustEditIt = 0; TEMPO_GUI_Switchyard_LA(''analyze'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	...
	'Callback','global JustEditIt; JustEditIt = 1; TEMPO_GUI_Switchyard_LA(''analyze'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	...
	'Callback','TEMPO_GUI_Switchyard_LA(''spike sorting'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''file open'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','pix', ...
	'BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''view codes'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','pix', ...
	'BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''view conditions'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 0.501960784313725], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''pick good trials'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 0.501960784313725], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''pick bad trials'');', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 0.501960784313725], ...
	'Callback','TEMPO_GUI_Switchyard_LA(''use sync pulses'');', ...
	'ListboxTop',0, ...
...
filePathName = textread('Z:\Labtools\Tools\LastFileName.txt','%s');
...
switch evt.Key
    case 'f2'
        TEMPO_GUI_Switchyard_LA('spike sorting');
    case 'f3'
        TEMPO_GUI_Switchyard_LA('load data');
    case 'f4'
        JustEditIt = 0; TEMPO_GUI_Switchyard_LA('analyze');
    case 'f5'  % +r
