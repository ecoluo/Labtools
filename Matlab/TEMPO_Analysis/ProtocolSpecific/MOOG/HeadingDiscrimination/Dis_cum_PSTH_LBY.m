...
ss = [str,' activeTuning\_allT'];
    suptitle(ss);
%     saveas(gcf,['Z:\LBY\Recording data\Polo\HD\' ss], 'tif');
%}

%----------plot tuning curves according to choices
% %{
set(figure(2001),'position',[20 20 1000 300]); clf;
if ~isempty(batch_flag)
...
str = [FILE,' Ch ',num2str(SpikeChan)];
    ...
    ss1 = [FILE,'_Ch_',num2str(SpikeChan),'_activeTuning_choice'];
    saveas(gcf,['/ion/gu_lab/byliu/Z/Polo/HD/' ss1], 'tif');
%}
...
for k = 1:length(unique_stimType)
    ...
    suptitle(str);
    SetFigure(10);
    saveas(gcf,['/ion/gu_lab/byliu/Z/Polo/HD/' str1], 'emf');
end
%}
