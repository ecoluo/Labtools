...
switch(Analysis{1})
    ...
    case '3D Tuning Analysis_LBY'
        if JustEditIt == 1
            edit Tuning_3D_analysis_LBY;
        else
            Tuning_3D_analysis_LBY(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, batch_flag);
        end
    case 'CurveFitting_3Plane'
        if JustEditIt == 1
            edit CurveFitting_3Plane;
        else
            CurveFitting_3Plane(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol);
        end
    ...
    case 'Eyetrace_LBY'
        ...
        %-----------------    Heading/Rotation local tuning     -----------------%
      
        case 'Plot local tuning'
        if JustEditIt == 1
            edit local_tuning_LBY;
        else
        ...
        if JustEditIt == 1
            ...
            Grating_LBY(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, batch_flag);
        end
        ...
        case 'Plot CP_LBY'
        if JustEditIt == 1
            edit HeadingDis_cum_LBY;
        else
            HeadingDis_cum_LBY(data, Protocol, Analysis, SpikeChan, StartEventBin, StopEventBin, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, batch_flag);
        end
    ...
    case 'Plot CP_shiftwindow_LBY'
        if JustEditIt == 1
            edit HeadingDis_cum_shiftwindow_LBY;
        else
            HeadingDis_cum_shiftwindow_LBY(data, Protocol, Analysis, SpikeChan, StartEventBin, StopEventBin, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, batch_flag);
        end
        %-----------------    delay saccade    -----------------%
        
    case 'Eyetrace_delaySac_LBY'
        if JustEditIt == 1
            edit Eyetrace_Delaysac_LBY;
        else
            Eyetrace_Delaysac_LBY(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, batch_flag);
        end
