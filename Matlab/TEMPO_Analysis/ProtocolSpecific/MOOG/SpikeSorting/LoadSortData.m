...
% fileName_sortData = textread('Z:\Labtools\LastFileName_sortData.txt','%s');
% set(handles.edit_FileName,'string',fileName_sortData);
...
% dfltDir = 'Z:\Data\MOOG\Qiaoqiao\raw';% Default data directory for HH20130826

% dfltDir = 'Z:\Data\MOOG\Qiaoqiao\Raw\';% Default data directory for LBY20161215
dfltDir = 'Z:\Data\MOOG\Polo\Raw\';% Default data directory for LBY20180111
...
OutFileName=['Z:\Data\Moog\', monkeyName, '\Analysis\SortedSpikes2\', dataFileName(1:end-4), '.mat'];
...
%     fileName = horzcat(fileName(fileName~=' '),'.smr');
    temp_name = fileName~=' ';
    fileName = fileName(temp_name(1:end-4));
    fileName = horzcat(fileName,'.smr'); %changed by Lwh 20170711
    ...
    switch monkeyN
        ...
        case 6
            handles.dataPath = 'Z:\Data\MOOG\Qiaoqiao\Raw\';
