...
time_vel = TEMPO1_Acceleration.times(3:duration*2000+3);
time_acc = TEMPO1_Acceleration.times(3:duration*2000+3);
veloc = vel(3:duration*2000+3);
accel = acc(3:duration*2000+3);
