...
clear all;
load('Z:\Data\TEMPO\BATCH\Polo_3DTuning\PSTH_OriData_Dark.mat');
Polo_3DTuning_T_Dark = Polo_3DTuning_T;
Polo_3DTuning_R_Dark = Polo_3DTuning_R;
...
TDark_name = cat(1,Polo_3DTuning_T_Dark.name);
TDark_ch = cat(1,Polo_3DTuning_T_Dark.ch);
...
for Dark_inx = 1:length(TDark_name)
    ...
    if ~isempty(ind_c) % find the cell for cells performed dark control
        ...
        if ~isempty(index) % find the exact channel
            pc = pc+1;
            T_inx = ind_c(index);
            T_DarknN(pc).name = Polo_3DTuning_T_Dark(Dark_inx).name;
            T_DarknN(pc).ch = Polo_3DTuning_T_Dark(Dark_inx).ch;
            if ~isempty(find(Polo_3DTuning_T(T_inx).stimType == 1))
                T_DarknN(pc).Tvesti_DDI = Polo_3DTuning_T(T_inx).DDI(find(Polo_3DTuning_T(T_inx).stimType == 1));
                T_DarknN(pc).Tvesti_ANOVA = Polo_3DTuning_T(T_inx).ANOVA(find(Polo_3DTuning_T(T_inx).stimType == 1));
                T_DarknN(pc).Tvesti_PreDir = Polo_3DTuning_T(T_inx).preDir{find(Polo_3DTuning_T(T_inx).stimType == 1)};
                T_DarknN(pc).Tvesti_ResponSig = Polo_3DTuning_T(T_inx).responSig(find(Polo_3DTuning_T(T_inx).stimType == 1));
                T_DarknN(pc).Tvesti_maxFR = Polo_3DTuning_T(T_inx).maxFR(find(Polo_3DTuning_T(T_inx).stimType == 1));
                T_DarknN(pc).Tvesti_minFR = Polo_3DTuning_T(T_inx).minFR(find(Polo_3DTuning_T(T_inx).stimType == 1));
                
                T_DarknN(pc).Tdark_DDI = Polo_3DTuning_T_Dark(Dark_inx).DDI;
                T_DarknN(pc).Tdark_ANOVA = Polo_3DTuning_T_Dark(Dark_inx).ANOVA;
                T_DarknN(pc).Tdark_PreDir = Polo_3DTuning_T_Dark(Dark_inx).preDir{:};
                T_DarknN(pc).Tdark_ResponSig = Polo_3DTuning_T_Dark(Dark_inx).responSig;
                T_DarknN(pc).Tdark_maxFR = Polo_3DTuning_T_Dark(Dark_inx).maxFR;
                T_DarknN(pc).Tdark_minFR = Polo_3DTuning_T_Dark(Dark_inx).minFR;
...
RDark_name = cat(1,Polo_3DTuning_R_Dark.name);
RDark_ch = cat(1,Polo_3DTuning_R_Dark.ch);
...
for Dark_inx = 1:length(RDark_name)
    ...
    if ~isempty(ind_c) % find the cell for cells performed dark control
        ...
        if ~isempty(index) % find the exact channel
            pc = pc+1;
            R_inx = ind_c(index);
            R_DarknN(pc).name = Polo_3DTuning_R_Dark(Dark_inx).name;
            R_DarknN(pc).ch = Polo_3DTuning_R_Dark(Dark_inx).ch;
            if ~isempty(find(Polo_3DTuning_R(R_inx).stimType == 1))
                R_DarknN(pc).Rvesti_DDI = Polo_3DTuning_R(R_inx).DDI(find(Polo_3DTuning_R(R_inx).stimType == 1));
                R_DarknN(pc).Rvesti_ANOVA = Polo_3DTuning_R(R_inx).ANOVA(find(Polo_3DTuning_R(R_inx).stimType == 1));
                R_DarknN(pc).Rvesti_PreDir = Polo_3DTuning_R(R_inx).preDir{find(Polo_3DTuning_R(R_inx).stimType == 1)};
                R_DarknN(pc).Rvesti_ResponSig = Polo_3DTuning_R(R_inx).responSig(find(Polo_3DTuning_R(R_inx).stimType == 1));
                R_DarknN(pc).Rvesti_maxFR = Polo_3DTuning_R(R_inx).maxFR(find(Polo_3DTuning_R(R_inx).stimType == 1));
                R_DarknN(pc).Rvesti_minFR = Polo_3DTuning_R(R_inx).minFR(find(Polo_3DTuning_R(R_inx).stimType == 1));
                
                R_DarknN(pc).Rdark_DDI = Polo_3DTuning_R_Dark(Dark_inx).DDI;
                R_DarknN(pc).Rdark_ANOVA = Polo_3DTuning_R_Dark(Dark_inx).ANOVA;
                R_DarknN(pc).Rdark_PreDir = Polo_3DTuning_R_Dark(Dark_inx).preDir{:};
                R_DarknN(pc).Rdark_ResponSig = Polo_3DTuning_R_Dark(Dark_inx).responSig;
                R_DarknN(pc).Rdark_maxFR = Polo_3DTuning_R_Dark(Dark_inx).maxFR;
                R_DarknN(pc).Rdark_minFR = Polo_3DTuning_R_Dark(Dark_inx).minFR;
...
plot([0 0.95],[0 0.95],'-','color',colorLGray);
text(0.1,0.8,['n = ',num2str(length(T_DarknN))]);
axis on;
hold off;
...
plot([0 0.95],[0 0.95],'-','color',colorLGray);
text(0.1,0.8,['n = ',num2str(length(R_DarknN))]);
xlabel('Dark DDI');
axis on;
hold off;
...
text(170,max(max(nelements_sig),max(nelements_nsig)),['n = ',num2str(length(T_DarknN))]);
plot(T_PreDir_diffSigMedian,max(max(nelements_sig),max(nelements_nsig))*1.1,'kv');
...
h2 = bar(ncenters_sig, nelements_sig, 0.8,'k','edgecolor','k');
set(h1,'linewidth',1.5);
text(170,max(max(nelements_sig),max(nelements_nsig)),['n = ',num2str(length(R_DarknN))]);
plot(R_PreDir_diffSigMedian,max(max(nelements_sig),max(nelements_nsig))*1.1,'kv');
...
plot([0 max(max(T_ResponDiff),max(T_Dark_ResponDiff))+20],[0 max(max(T_ResponDiff),max(T_Dark_ResponDiff))+20],'-','color',colorLGray);
text(max(T_ResponDiff)+20,max(T_Dark_ResponDiff)+20,['n = ',num2str(length(T_DarknN))]);
...
plot([0 max(max(R_ResponDiff),max(R_Dark_ResponDiff))+20],[0 max(max(R_ResponDiff),max(R_Dark_ResponDiff))+20],'-','color',colorLGray);
text(max(R_ResponDiff)+20,max(R_Dark_ResponDiff)+20,['n = ',num2str(length(R_DarknN))]);
