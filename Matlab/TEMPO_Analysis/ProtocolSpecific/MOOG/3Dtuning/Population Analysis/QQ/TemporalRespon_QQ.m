...
TotalNoTranVest = nansum(logical(cat(1,QQ_3DTuning_T.stimType) == 1));
TotalNoTranVis = nansum(logical(cat(1,QQ_3DTuning_T.stimType) == 2));
ResponTranVest = nansum(cat(1,T.vestiResponSig));
ResponTranVis = nansum(cat(1,T.visResponSig));

TotalNoRotVest = nansum(logical(cat(1,QQ_3DTuning_R.stimType) == 1));
TotalNoRotVis = nansum(logical(cat(1,QQ_3DTuning_R.stimType) == 2));
