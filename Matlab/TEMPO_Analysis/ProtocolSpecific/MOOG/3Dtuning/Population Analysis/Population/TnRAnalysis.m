...
for R_inx = 1:length(R_name)
    ...
    if ~isempty(ind_c) % find the cell for both T&R
        ...
        if ~isempty(index) % find the exact channel for the cell for both T&R
            pc = pc+1;
            T_inx = ind_c(index);
            TnR(pc).name = QQ_3DTuning_R(R_inx).name;
            TnR(pc).ch = QQ_3DTuning_R(R_inx).ch;
            TnR(pc).T_stimType = QQ_3DTuning_T(T_inx).stimType;
            TnR(pc).R_stimType = QQ_3DTuning_R(R_inx).stimType;
            if ~isempty(find(QQ_3DTuning_T(T_inx).stimType == 1))
                TnR(pc).Tvesti = 1;
                TnR(pc).Tvesti_DDI = QQ_3DTuning_T(T_inx).DDI(find(QQ_3DTuning_T(T_inx).stimType == 1));
                TnR(pc).Tvesti_ANOVA = QQ_3DTuning_T(T_inx).ANOVA(find(QQ_3DTuning_T(T_inx).stimType == 1));
                TnR(pc).Tvesti_PreDir = QQ_3DTuning_T(T_inx).preDir{find(QQ_3DTuning_T(T_inx).stimType == 1)};
                TnR(pc).Tvesti_ResponSig = QQ_3DTuning_T(T_inx).responSig(find(QQ_3DTuning_T(T_inx).stimType == 1));
            ...
            if ~isempty(find(QQ_3DTuning_T(T_inx).stimType == 2))
                TnR(pc).Tvis = 1;
                TnR(pc).Tvis_DDI = QQ_3DTuning_T(T_inx).DDI(find(QQ_3DTuning_T(T_inx).stimType == 2));
                TnR(pc).Tvis_ANOVA = QQ_3DTuning_T(T_inx).ANOVA(find(QQ_3DTuning_T(T_inx).stimType == 2));
                TnR(pc).Tvis_PreDir = QQ_3DTuning_T(T_inx).preDir{find(QQ_3DTuning_T(T_inx).stimType == 2)};
                TnR(pc).Tvis_ResponSig = QQ_3DTuning_T(T_inx).responSig(find(QQ_3DTuning_T(T_inx).stimType == 2));
            else
                TnR(pc).Tvis = nan;
            ...
            if ~isempty(find(QQ_3DTuning_R(R_inx).stimType == 1))
                TnR(pc).Rvesti = 1;
                TnR(pc).Rvesti_DDI = QQ_3DTuning_R(R_inx).DDI(find(QQ_3DTuning_R(R_inx).stimType == 1));
                TnR(pc).Rvesti_ANOVA = QQ_3DTuning_R(R_inx).ANOVA(find(QQ_3DTuning_R(R_inx).stimType == 1));
                TnR(pc).Rvesti_PreDir = QQ_3DTuning_R(R_inx).preDir{find(QQ_3DTuning_R(R_inx).stimType == 1)};
                TnR(pc).Rvesti_ResponSig = QQ_3DTuning_R(R_inx).responSig(find(QQ_3DTuning_R(R_inx).stimType == 1));
            else
                TnR(pc).Rvesti = nan;
            ...
            if ~isempty(find(QQ_3DTuning_R(R_inx).stimType == 2))
                TnR(pc).Rvis = 1;
                TnR(pc).Rvis_DDI = QQ_3DTuning_R(R_inx).DDI(find(QQ_3DTuning_R(R_inx).stimType == 2));
                TnR(pc).Rvis_ANOVA = QQ_3DTuning_R(R_inx).ANOVA(find(QQ_3DTuning_R(R_inx).stimType == 2));
                TnR(pc).Rvis_PreDir = QQ_3DTuning_R(R_inx).preDir{find(QQ_3DTuning_R(R_inx).stimType == 2)};
                TnR(pc).Rvis_ResponSig = QQ_3DTuning_R(R_inx).responSig(find(QQ_3DTuning_R(R_inx).stimType == 2));
            else
                TnR(pc).Rvis = nan;
...
[h,p_DDI_vesti] = ttest(T_DDISig_vesti,R_DDISig_vesti)
axis on;
hold off;
...
[h,p_DDI_vis] = ttest(T_DDISig_vis,R_DDISig_vis)
...
plot(PreDirSig_diff_vesti_median,max(max(nelements_sig),max(nelements_nsig))*1.1,'kv', 'markerfacecolor','k');
...
plot(PreDirSig_diff_vis_median,max(max(nelements_sig),max(nelements_nsig))*1.1,'kv', 'markerfacecolor','k');
