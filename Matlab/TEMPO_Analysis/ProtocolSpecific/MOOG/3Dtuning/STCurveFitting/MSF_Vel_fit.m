...
if allow_negative
    LB = [0 -1.5*(max_val-min_val) 0.001 (0*45*pi/180) 0 0 -0.5];   %     lower bounds
%     LB = [0 -1.5*(max_val-min_val) 0.001 (0*45*pi/180) 1.115 0 -0.5];   %     lower bounds
    UB = [1.35*max_val 1.5*(max_val-min_val) 10 (8*45*pi/180) max(t) 6 0];   % upper bounds

else
    LB = [0 0 0.001 (0*45*pi/180) 0 0 -0.5];   % lower bounds
