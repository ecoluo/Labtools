...
data = 3; % if 3D, set 3 (2 vectors with azimuth and elevation), lambert transform will be forced (cosine transformed)
...
bin_num = 10;  % asign how many bins should be there, this is a test of the bin, results would be a little varied according to how you bin your data

aa = preferDire{1,1}(:,1); % change here
dim = size(aa);
index_n = 1:1:dim(1);
num_perm =1000;
