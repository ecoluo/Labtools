...
modelFit_AJ.A = AJ_A_Com(modelFitPara_AJ([1:12,21]),st_data);
modelFit_AJ.J = AJ_J_Com(modelFitPara_AJ([1:4,13:20,21]),st_data);

% model fit spatial tuning
modelFit_AJ_spatial.A = d_cos_tuning(modelFitPara_AJ(5:12),st_data(1:13));
modelFit_AJ_spatial.J = d_cos_tuning(modelFitPara_AJ(13:20),st_data(1:13));
%% analysis
data_num = 26*nBins;
para_num = 10;
