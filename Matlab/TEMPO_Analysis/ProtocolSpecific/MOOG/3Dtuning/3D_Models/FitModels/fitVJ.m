...
modelFit_VJ.V = VJ_V_Com(modelFitPara_VJ([1:12,21]),st_data);
modelFit_VA.J = VJ_J_Com(modelFitPara_VJ([1:4,13:20,21]),st_data);

% model fit spatial tuning
modelFit_VJ_spatial.V = d_cos_tuning(modelFitPara_VJ(5:12),st_data(1:13));
modelFit_VJ_spatial.J = d_cos_tuning(modelFitPara_VJ(13:20),st_data(1:13));
%% analysis
data_num = 26*nBins;
para_num = 10;
