...
modelFit_VAJ.V = VAJ_V_Com(modelFitPara_VAJ([1:12,29,30]),st_data);
modelFit_VAJ.A = VAJ_A_Com(modelFitPara_VAJ([1:4,13:20,29,30]),st_data);
modelFit_VAJ.J = VAJ_J_Com(modelFitPara_VAJ([1:4,21:28,29,30]),st_data);

% model fit spatial tuning
modelFit_VAJ_spatial.V = d_cos_tuning(modelFitPara_VAJ(5:12),st_data(1:13));
modelFit_VAJ_spatial.A = d_cos_tuning(modelFitPara_VAJ(13:20),st_data(1:13));
modelFit_VAJ_spatial.J = d_cos_tuning(modelFitPara_VAJ(21:28),st_data(1:13));
% modelFit_VAJ_spatial.V = cos_tuning(modelFitPara_VAJ(5:7),st_data(1:13));
% modelFit_VAJ_spatial.A = cos_tuning(modelFitPara_VAJ(13:15),st_data(1:13));
% modelFit_VAJ_spatial.J = cos_tuning(modelFitPara_VAJ(21:23),st_data(1:13));
%% analysis
data_num = 26*nBins;
para_num = 14;
