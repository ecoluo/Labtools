...
modelFit_PVAJ.V = PVAJ_V_Com(modelFitPara_PVAJ([1:7,20:22,23]),st_data);
modelFit_PVAJ.A = PVAJ_A_Com(modelFitPara_PVAJ([1:3,8:11,20:22]),st_data);
modelFit_PVAJ.J = PVAJ_J_Com(modelFitPara_PVAJ([1:3,12:15,20:22,24]),st_data);
modelFit_PVAJ.P = PVAJ_P_Com(modelFitPara_PVAJ([1:3,16:19,20:22,25]),st_data);
